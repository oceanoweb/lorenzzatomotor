...
<html>
	<head>
		<title>Lorenzzato Motor</title>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		<meta name="description" content="Loja de automóveis" />
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				...
				<!-- Logo -->
					<h1 id="logo">Lorenzzato Motor</h1>
		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container 75%">
					...
					<strong>Lorenzzato Motor...Realizando sonhos desde </strong>
					<footer>
		...
		<!-- Contact -->
			<section id="contact" class="main style3 secondary">
				<div class="content container">
					<header>
						<h2>Contato</h2>
						<p>Mande sua mensagem ou peça uma contação de automóvel</p>
					</header>
							...
							<?php if($msg==enviado): ?>
								...
								<?php else: ?>
									...
									<form method="post" action="form.php">
										<div class="row 50%">
											<div class="6u"><input type="text" name="name" placeholder="Nome" /></div>
											<div class="6u"><input type="email" name="email" placeholder="E-mail" /></div>
										</div>
										<div class="row 50%">
